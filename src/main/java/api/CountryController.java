...
public class CountryController {
	...
	public String getInfoCountry(Ip ip) throws Exception {
		try {
			//Antes informaci�n del pa�s en la API externa lo busco en mi objecto singleto y en mi bd
	...
	public String calculateRateUSD(Ip ip, boolean countryFound) throws JsonProcessingException, ParseException, JSONException {
		try {
			//Verifico que sea necesario actualizar las tarifas de cambio, si ya se consult� para el mismo d�a utilizo el singleton
